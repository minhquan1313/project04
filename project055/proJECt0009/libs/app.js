...
redirectParentWebpage.onclick = function () {
  ...
  if (tempUrlPLength >= 0) tempUrlPLength++;

  console.log(tempUrlPLength);

  // if (tempUrlPLength >= 0)
  //   window.location.replace(
  //     tempUrl.slice(0, tempUrl.indexOf("/", tempUrlPLength))
  //   );
  // else window.location.replace(tempUrl.slice(0, tempUrlLength));

  if (tempUrlPLength >= 0)
    console.log(tempUrl.slice(0, tempUrl.indexOf("/", tempUrlPLength)));
  else console.log(tempUrl.slice(0, tempUrlLength));
